...
<div class="hero-banner">
    <div>
        ...
        <p class="text-light opacity-75 mt-3" style="max-width: 450px;">Nikmat 1 banget 1 harmoni sempurna dari biji kopi pilihan yang dipanggang dengan penuh cinta.</p>
        <div class="mt-4">
